...
export function OpenInV0Button({
  ...
  return (
    <Button
      ...
      size="sm"
      className={`text-xs flex items-center gap-2 rounded-md bg-black px-4 py-1 text-white hover:bg-black/90 dark:bg-white dark:text-black dark:hover:bg-white/90 ${className}`}
      onClick={handleClick}
      {...props}
    >
      <span>Open in</span>
